...
public class SwipeCardCallBack extends ItemTouchHelper.SimpleCallback
{
    ...
    public SwipeCardCallBack(RecyclerView rv, RecyclerView.Adapter adapter, List datas)
    {
        this(0, ItemTouchHelper.DOWN | ItemTouchHelper.UP | ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT, rv, adapter, datas);
    }

    public SwipeCardCallBack(int dragDirs, int swipeDirs, RecyclerView rv, RecyclerView.Adapter adapter, List datas)
    {
